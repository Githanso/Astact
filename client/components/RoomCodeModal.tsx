...
// Rakip odaya katilinca App bunu kendiliginden kapatir — bu yuzden kapatma ikonu YOK:
// kodu gorup odadan kacilmamasi icin rakip gelene kadar bu ekran kapanamaz.
...
const RoomCodeModal: React.FC<RoomCodeModalProps> = ({ isOpen, roomCode, lang }) => {
