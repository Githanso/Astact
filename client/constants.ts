...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  TR: {
    ...
    combatMiner: 'İstihkamcı Mayını imha etti ve kareye ilerledi!',
    combatSpy: 'Casus, Mareşal’i yendi!',
    combatHigherWins: '{a} ({rw} {ar}) > {d} ({rw} {dr}) — Rütbesi büyük olan yendi ve yerine ilerledi!',
    combatFlagCaptured: '{a} Sancağı ele geçirdi! ZAFER!',
    combatBombHit: '{a} Mayına bastı ve patladı! Mayın da yok oldu.',
  ...
  EN: {
    ...
    combatMiner: 'The Miner defused the Mine and advanced!',
    combatSpy: 'The Spy defeated the Marshal!',
    combatHigherWins: '{a} ({rw} {ar}) > {d} ({rw} {dr}) — the higher rank won and advanced!',
    combatFlagCaptured: '{a} captured the Banner! VICTORY!',
    combatBombHit: '{a} stepped on the Mine and was destroyed! The Mine was destroyed too.',
