...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  TR: {
    ...
    ruleSpy: 'Casus, Mareşal\'e saldırdığında kazanır. Mareşal saldırırsa Casus ölür.',
    ...
    ruleMove: 'Taşlar tek kare, düz hareket eder. Geri adım yasak; yana hareket serbest.',
  ...
  EN: {
    ...
    ruleSpy: 'The Spy wins when it attacks the Marshal. If the Marshal attacks, the Spy dies.',
    ...
    ruleMove: 'Pieces move one square in a straight line. Moving backward is forbidden; sideways is allowed.',
  ...
  JA: {
    ...
    ruleSpy: 'スパイは元帥に攻撃した場合に勝ちます。元帥から攻撃されるとスパイが負けます。',
    ...
    ruleMove: '駒は縦か横に1マスずつ動きます。後退は禁止、横移動は可能です。',
  ...
  KO: {
    ...
    ruleSpy: '스파이는 원수를 공격할 때 이깁니다. 원수가 먼저 공격하면 스파이가 죽습니다.',
    ...
    ruleMove: '기물은 가로 또는 세로로 한 칸씩 움직입니다. 후퇴는 금지이고 옆으로 이동은 가능합니다.',
